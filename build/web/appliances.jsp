...
//    let water_purifier = document.getElementById("water_purifier");
//
//    function initial() {
//        fridge.checked = true;
//        display(fridge_data)
...
//            ac.checked = false;
//            washing_machine.checked = false;
//            induction.checked = false;
//            television.checked = false;
//            microwave.checked = false;
//            water_purifier.checked = false;
//            setTimeout(function () {
//                display(fridge_data)
//            }, 1000)
//
...
//        }
//    })
//    washing_machine.addEventListener("change", function () {
//        if (washing_machine.checked === true) {
//            ac.checked = false;
//            fridge.checked = false;
//            induction.checked = false;
//            microwave.checked = false;
...
//            water_purifier.checked = false;
//            setTimeout(function () {
//                display(washing_machine_data)
//            }, 1000)
//        }
//    })
//    microwave.addEventListener("change", function () {
//        if (microwave.checked === true) {
//            ac.checked = false;
//            fridge.checked = false;
//            induction.checked = false;
//            washing_machine.checked = false;
...
//            television.checked = false;
//            setTimeout(function () {
//                display(microwave_data)
//            }, 1000)
//        }
//    })
//
//    water_purifier.addEventListener("change", function () {
//        if (water_purifier.checked === true) {
//            fridge.checked = false;
//            induction.checked = false;
//            washing_machine.checked = false;
//            microwave.checked = false;
...
//            ac.checked = false;
//            setTimeout(function () {
//                display(water_purifier_data)
//            }, 1000)
//
//        }
//    })
//    induction.addEventListener("change", function () {
//        if (induction.checked === true) {
//            fridge.checked = false;
//            washing_machine.checked = false;
//            microwave.checked = false;
//            television.checked = false;
...
//            ac.checked = false;
//            setTimeout(function () {
//                display(induction_data)
//            }, 1000)
//
//        }
//    })
//    television.addEventListener("change", function () {
//        if (television.checked === true) {
//            fridge.checked = false;
//            washing_machine.checked = false;
//            microwave.checked = false;
//            water_purifier.checked = false;
