<%-- 
    Document   : select_delivary_address
    Created on : 10 Oct, 2023, 6:50:57 PM
    Author     : atrib
--%>
...
<html>
    ...
    <body>
        ...
        <div class="navbar">
            <nav class="navbar-h">
                <div id="bak">
                    <button id="back" onclick="location.href='cart.jsp'"><i class="fa fa-arrow-left"></i> Back</button>
                </div>
                <div id="text">
                ...
                <table id="tbl-student" class="table table-responsive table-bordered" cellpadding ="0" width="100%">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td><button onclick="location.href='payment_gateway.jsp?USER_ADDRESS_ID=<%=USER_ADDRESS_ID%>'" id="select">SELECT</button></td>
