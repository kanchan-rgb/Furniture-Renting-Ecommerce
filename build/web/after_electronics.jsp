    ...
    <body>
        ...
        <div id="login_popup">
            ...
            <div>
                ...
                <input type="text" id="user_name_data" placeholder="Enter User Name*" required>
                <span class="ab"><i style="float: right;" class="fas fa-eye" onclick="show()"></i></span>
                ...
                <center><img src="IMAGE/Logo/Small Transparent.png" style="width: 200px;height: 200px;"></center>
...
//    let gaming_console = document.getElementById("gaming_console");
//
//    function initial() {
//        pc.checked = true;
//        display(pc_data)
...
//        }
//    })
//    gaming_console.addEventListener("change", function () {
//        if (gaming_console.checked === true) {
//            pc.checked = false;
//            laptop.checked = false;
//            tablet.checked = false;
//            setTimeout(function () {
//                display(gaming_console_data)
//            }, 1000)
//
//        }
//    })
