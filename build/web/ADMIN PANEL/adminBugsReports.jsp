...
<html>
    <head>
        ...
        <title>BUGS REPORTS PANELS</title>
    ...
    <body>
        <div class="navbar">
            <nav class="navbar-h">
                <div id="text">
                    <p style="text-align: center"><b>RENTKARO BUGS REPORTS</b></p>
                </div>
                <div>
        ...
        <%
            ...
            ops = oconn.prepareStatement("SELECT * FROM BUGSREPORT ORDER BY B_ID DESC");
...
//           request.setAttribute("imagedata", rs.getBytes("PRODUCT_IMAGE"));
                        ...
                        byte[] videoData = ors.getBytes("B_VIDEO");

                        String ID = ors.getString("B_ID");
                ...
                <tr>
                    <th><%=c%></th>
                        <%                        for (counter = 2; counter <= orsm.getColumnCount(); counter++) {
                                if (orsm.getColumnName(counter).equals("B_IMAGE")) {
                    ...
                    <td> 
                        ...
                        <br>
                        <button id="view"><a style="text-decoration: none;color: white" href="BugsReportImageView.jsp?ID=<%=ID%>">VIEW IMAGE</a></button>
                    </td>
                        <%
                        } else {
                        %>
                    <td> <img width="50px" height="50px" src="../IMAGE/Logo/Small Transparent.png"/></td>
                        ...
                        } else if (orsm.getColumnName(counter).equals("B_VIDEO")) {
                            if (videoData != null) {
                    ...
                    <td>
                        ...
                        <button id="delete"><a style="text-decoration: none;color: white" onclick="return confirm('Are You Sure You Want To Delete This Complain?');" href="deleteBugsReport.jsp?ID=<%=ID%>">DELETE</a></button>
