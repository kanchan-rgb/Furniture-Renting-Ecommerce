...
<html>
    ...
    <center>
        <form method="POST" action="http://localhost:8080/RENT_KARO/NewAddProduct" enctype="multipart/form-data">
            <div class="fild">
                <label for="product_name" class="box">Product Name : </label>
                <input type="text" name="db_product_name" id="product_name" required>
            </div>
            <div class="fild">
                <label for="product_image" class="box">Product Image : </label>
                <input type="file" name="db_product_image" id="product_image" accept="image/png,image/jpg, image/jpeg" required>
            </div>
            <div class="fild">
                <label for="product_url" class="box">Product IMG URL : </label>
                <input type="text" name="db_product_url" id="product_url" required>
            </div>
            <div class="fild">
                <label for="product_price" class="box">Product Price : </label>
                <input type="number" name="db_product_price" id="product_price" required>
            </div>
            <div class="fild">
                <label for="product_quantity" class="box">Product Quantity : </label>
                <input type="number" name="db_product_quantity" id="product_quantity" required>
            </div>
            <div class="fild">
            ...
            <div class="fild">
                ...
                <br>
                <textarea name="db_product_description" type="text" id="product_description" placeholder="Write here....." required></textarea>
            </div>
            <div class="fild">
                ...
                <button type="submit" name="bSubmit" id="bSubmit">Register</button>
            </div>
        </form>
    </center>
</body>
