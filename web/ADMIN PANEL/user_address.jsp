<%-- 
    ...
    Created on : 30 Oct, 2023, 10:36:36 AM
    Author     : atrib
--%>
...
<%
    ...
    ops = oconn.prepareStatement("SELECT * FROM USERADDRESS WHERE USER_ID=?");
...
<html>
    ...
    <body>
        <div class="navbar">
            <nav class="navbar-h">
                <div id="text">
                    <p style="text-align: center"><b>USER ADDRESS DETAILS</b></p>
                </div>
                <div>
