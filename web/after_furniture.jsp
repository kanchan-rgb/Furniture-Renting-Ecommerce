...
//    let almirah = document.getElementById("almirah");
//
//    function initial() {
//        bed.checked = true;
//        display(bed_data)
...
//        }
//    })
//    sofa.addEventListener("change", function () {
//        if (sofa.checked === true) {
//            bed.checked = false;
//            table.checked = false;
//            chair.checked = false;
//            almirah.checked = false;
...
//    })
//
//    almirah.addEventListener("change", function () {
//        if (almirah.checked === true) {
//            bed.checked = false;
//            table.checked = false;
//            chair.checked = false;
//            sofa.checked = false;
//            setTimeout(function () {
//                display(almirah_data)
//            }, 1000)
//
//        }
//    })
